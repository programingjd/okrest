![jcenter](https://img.shields.io/badge/_jcenter_-_2.7.0-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-_8/8-green.png?style=flat)
# okrest
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/ok/rest/okrest/2.7.0/okrest-2.7.0.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.ok.rest:okrest:2.7.0'
}
```
