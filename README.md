![jcenter](https://img.shields.io/badge/_jcenter_-_3.4.2-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-_10/10-green.png?style=flat)
# okrest
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/ok/rest/okrest/3.4.2/okrest-3.4.2.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.ok.rest:okrest:3.4.2'
}
```
