![jcenter](https://img.shields.io/badge/_jcenter_-_3.1.1-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-_8/8-green.png?style=flat)
# okrest
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/ok/rest/okrest/3.1.1/okrest-3.1.1.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.ok.rest:okrest:3.1.1'
}
```
